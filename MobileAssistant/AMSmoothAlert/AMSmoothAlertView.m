...
- (void) labelSetupWithTitle:(NSString*) title andText:(NSString*) text
{
    ...
    _titleLabel.font = [UIFont fontWithName:@"NeoTechAlt-LightItalic" size:17.0f];
    ...
    _textLabel.font = [UIFont fontWithName:@"NeoTechAlt" size:12.0f];
...
- (void) buttonSetupForType:(AlertType)type withCancelButton:(BOOL) hasCancelButton andColor:(UIColor*) color
{
    ...
    else
    {
        if (hasCancelButton)
        {
            ...
            _cancelButton.titleLabel.font = [UIFont fontWithName:@"NeoTechAlt" size:13.0f];
        ...
        _defaultButton.titleLabel.font = [UIFont fontWithName:@"NeoTechAlt" size:13.0f];
