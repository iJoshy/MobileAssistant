...
#define GREEN [UIColor colorWithRed:0.443 green:0.620 blue:0.094 alpha:1]
...
- (void)commonInit
{
    ...
    [self setButtonTextColor:GREEN forState:UIControlStateNormal];
    [self setBackgroundColor:[UIColor whiteColor]];
    
    [self setLabelFont:[UIFont fontWithName:@"NeoTechAlt" size:16.0f]];
